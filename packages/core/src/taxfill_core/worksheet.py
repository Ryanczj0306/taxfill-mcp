...
|---|---|---|---|---|
| 1 | e.g. F-1 (enrolled — bachelor's/master's/PhD) | 2022-08-24 | 2024-05-17 | studying |
| 2 | e.g. F-1 OPT (12-month work authorization) | 2024-06-10 | 2025-06-09 | working full-time |
| 3 | e.g. F-1 STEM OPT (24-month extension) | | | |
| 4 | e.g. cap-gap (bridge after H-1B selection) | | | |
| 5 | e.g. H-1B (start = the I-797 start date) | 2025-10-01 | present | working full-time |
| 6 | | | | |
...
- Their name/alias: __________　Their status (U.S. citizen / green card / visa type + dates): __________
...
|---|---|---|---|---|
| 1 | 例：F-1（在读，本科/硕士/博士） | 2022-08-24 | 2024-05-17 | 上学 |
| 2 | 例：F-1 OPT（12 个月实习许可） | 2024-06-10 | 2025-06-09 | 全职工作 |
| 3 | 例：F-1 STEM OPT（24 个月延期） | | | |
| 4 | 例：cap-gap（H-1B 抽中后的过渡期） | | | |
| 5 | 例：H-1B（生效日 = I-797 上的 start date） | 2025-10-01 | 至今 | 全职工作 |
| 6 | | | | |
...
如果同住有伴侣但**没结婚**：
- 对方姓名/代称：__________　对方身份（美国公民 / 绿卡 / 签证类型 + 日期）：__________
