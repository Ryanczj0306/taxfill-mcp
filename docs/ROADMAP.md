...
- [ ] **H9 — reward / other-income characterization + the NRA FDAP corner
      (Pub 525 rebate-vs-income).** Gap: nothing answered whether an account
      bonus or a card/bank reward (for example an
      ...
      the Treasury treaty texts) — but the characterization itself had to come
      ...
      **Acceptance:** every query in the three bullets above resolves to its
      own topic, no neighbouring topic is stolen, and an agent asked "is a
