...
4. **Phase H** (planning mode, from the FIELD_NOTES gap catalogue). Rationale from
   [`FIELD_NOTES.md`](FIELD_NOTES.md): such a planning drive reaches 4 of the 22 tools and
   every number that decides the answer has to be computed *outside* the
   engine, over irs.gov figures the agent has to re-research.
   ...
   * **[x] STAGE 2 — the shared ledger spine (DONE 2026-08-07).** H4-WI1,
     ...
     throw away — the table a hand analysis would rebuild). Plus
